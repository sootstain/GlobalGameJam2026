...
namespace Yarn.Unity
{
    ...
    /// </summary>
    public sealed class VoiceOverPresenterHHH : DialoguePresenterBase
    {
...
#pragma warning restore CS8618
        ...
        public override async YarnTask RunLineAsync(LocalizedLine dialogueLine, LineCancellationToken lineCancellationToken)
        {
            ...
            {
                voiceOverClip = GlobalAudioStuff.instance.defaultVoiceOverClip;
                
                Debug.Log($"Playing voice over failed because the localised line {dialogueLine.TextID} " +
                    $"either didn't have an asset, or its asset was not an {nameof(AudioClip)}.", gameObject);

                // do not end line prematurely. leave the text alone!!!
